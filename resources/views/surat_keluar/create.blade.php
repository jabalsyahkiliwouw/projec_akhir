    ...
    <div class="page-inner">
      <div class="page-header">
        ...
        <ul class="breadcrumbs mb-3">
          ...
          <li class="nav-item">
            <a href="{{route('surat_keluar.create')}}">{{$title}}</a>
          </li>
        </ul>
      </div>
      <div class="row">
        <div class="col">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form class="row g-3" action="{{ route('surat_keluar.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                      ...
                      <div class="col-md-6 mb-2">
                          ...
                          <input type="text" class="form-control" placeholder="Masukkan Penerima Surat disini...." name="penerima" value="{{ old('penerima') }}">
                      </div>
                      <div class="col-md-6 mb-2">
