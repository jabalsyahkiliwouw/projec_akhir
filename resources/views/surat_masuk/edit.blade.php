        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" action="{{ route('surat_masuk.update', $suratMasuk->id_surat_masuk) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="col-md-6 mb-2">
                  <label class="form-label" for="">Nomor Surat<abbr title="" style="color: black">*</abbr></label>
                  <input type="text" class="form-control" placeholder="Masukkan Nomor Surat disini...." name="nomor_surat" value="{{ $suratMasuk->nomor_surat}}">
              </div>
              <div class="col-md-6 mb-2">
                  <label class="form-label" for="">Pengirim <abbr title="" style="color: black">*</abbr></label>
                  <input type="text" class="form-control" placeholder="Masukkan Pengirim Surat disini...." name="pengirim" value="{{ $suratMasuk->pengirim}}">
              </div>
              <div class="col-md-6 mb-2">
              ...
              <div class="col-md-6 mb-2">
                  ...
                  <input type="text" class="form-control" placeholder="Masukkan Perihal disini...." name="perihal" value="{{ $suratMasuk->perihal}}">
              </div>
              <div class="col-12 mb-4">
                <label for="">Ringkasan </label>
                <textarea name="ringkasan" id="editor" cols="30" rows="10">{{ $suratMasuk->ringkasan }}</textarea>
              </div>
